...
? What is the difference when styling in HTML and JSX?

  -> JSX focuses on HTML properties, rather than HTML attributes. HTML attributes are part of the HTML code and are stored in the DOM as attribute nodes. HTML properties, on the other hand, are accessed using JavaScript and are stored in the DOM as property nodes. HTML attributes are named using kebab-case, such as “background-color”, while HTML properties are named using camelCase, such as “backgroundColor".
