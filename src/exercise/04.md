...
? What are components?
  ...
  -> Components are basically functions that return something "renderable"

? PropTypes aren't commonly used in modern React. What do we use for static type checking instead? 
